...
it('renders correct name', () => {
  ...
  it('should call onPlayerScoreChange with 1 when plus button is clicked', () => {
    ...
    const plusButton = playerComponent.find('.Player__plusbutton');
  ...
  it('should call onPlayerScoreChange with -1 when minus button is clicked', () => {
    ...
    const minusButton = playerComponent.find('.Player__minusbutton');
  ...
  it('should call onPlayerRemove when the remove button is clicked', () => {
    const mockedOnPlayerRemove = jest.fn();
    const playerComponent = shallow(<Player  onPlayerRemove={mockedOnPlayerRemove} />);
  
    const removeButton = playerComponent.find('.removePlayer');
